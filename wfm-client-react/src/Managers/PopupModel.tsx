  ...
  async function UpdateEmployee() {
     try { 
       ...
       if(response.status === 200){ 
         const res = await axios.post("http://localhost:8000/manager/insertsoftlock", { employeeid: parseInt(props.id),manager: localStorage.getItem("username"),responsemessage: text}); 
        }
       console.log(text); 
           ...
           <Modal show={props.show} onHide={props.toggle}>
             ...
             <Modal.Body>
                 <div>
                   ...
                   <textarea value={text} rows={5} cols={50} onChange={handlechange}/>
                 </div>
             </Modal.Body>
             <Modal.Footer>
